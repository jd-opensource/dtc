...
class DB {
 public:
  ...
  struct Properties {
    ...
    //  "rocksdb.job_operation-size-active-mem-table" - returns approximate size of active
    //      memtable (bytes).
    static const std::string kCurSizeActiveMemTable;

    //  "rocksdb.job_operation-size-all-mem-tables" - returns approximate size of active
  ...
  //  "rocksdb.job_operation-size-active-mem-table"
  //  "rocksdb.job_operation-size-all-mem-tables"
