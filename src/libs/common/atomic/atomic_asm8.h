...
static __inline__ long long atomic8_return_set(atomic8_t *v, long long i)
{
	...
	__asm__ __volatile__("       pushl           %%ebx\n"
			     ...
			     : "+A"(r)
			     : "ir"(v), "ir"((int)i),
			       "c"((int)((unsigned long long)i >> 32))
			     : "memory", "cc");
#else
	__asm__ __volatile__("1:     repz; nop\n" // aka pause
			     "lock;  cmpxchg8b       %1\n"
			     "       jnz             1b\n"
			     : "+A"(r), "+o"(v->counter)
			     : "b"((int)i),
...
static __inline__ long long atomic8_add(long long i, atomic8_t *v)
{
	...
	__asm__ __volatile__("       pushl           %%ebx\n"
			     ...
			     : "+A"(r)
			     : "ir"(v), "ir"((int)i),
			       "ir"((int)((unsigned long long)i >> 32))
			     : "memory", "ecx", "cc");
#else
	__asm__ __volatile__("1:     movl            %2, %%ebx\n"
			     "       movl            %3, %%ecx\n"
			     "       addl            %%eax, %%ebx\n"
			     "       adcl            %%edx, %%ecx\n"
			     "repz;  nop\n"
