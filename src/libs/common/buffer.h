...
class buffer {
	...
	inline char *cursor(void)
	{
		return buf + dataSize;
	}
	inline const char *cursor(void) const
	{
		return buf + dataSize;
	}
	...
	inline unsigned int needed(void) const
	{
		return needSize;
	}
	inline unsigned int remain(void) const
	{
		return bufSize - dataSize;
	}
	inline unsigned int margin(void) const
	{
		return needSize < bufSize ? 0 : needSize - bufSize;
	}
